        ...
        child: Align(
          ...
          child: Container(
            decoration: BoxDecoration(
                ...
                color: forwardColor ?? Colors.teal,
                boxShadow: [
                  BoxShadow(
                      color: forwardColor != null
                          ? forwardColor.withOpacity(0.38)
                          : Colors.teal.withOpacity(0.38),
                      blurRadius: 10,
                      spreadRadius: 6,
                      offset: Offset(0, 8))
                ]),
  ...
  void paint(Canvas canvas, Size size) {
    var paint = Paint()
      ..shader = ui.Gradient.linear(
        ...
        [
          bottomSheetColor ?? firstGradiantColor ?? const Color(0xff62cbe5),
          bottomSheetColor ?? secondGradiantColor ?? Colors.black54.withOpacity(0.9)
        ],
      )
